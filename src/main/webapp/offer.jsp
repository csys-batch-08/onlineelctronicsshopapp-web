...
body {
	background-image: url("assests/images/banner3.jpg");
...
<br>
	...
	<input style="float:right;" type="submit" value="search">
		...
		<tr>
          ...
          <c:forEach items="${offer}" var="offerComponent">
            <td>
			<table id="components">
			<caption></caption>
			<tbody>
			...
			<td><img alt="#offercomponentimage" src="assests/images/${offerComponent.image}"
				...
				Component Name:${offerComponent.componentName}<br><br>
				Category Name:${offerComponent.categoryName}<br><br>
				Description:${offerComponent.description}<br><br>
				<del>${offerComponent.price}</del>
				Price:${offerComponent.price *.90}Rs<br><br>
				
				<a class="btn" href="OfferDetailServlet?componentName=${offerComponent.componentName}&categoryName=${offerComponent.categoryName}&price=${offerComponent.price *.90}">Buy</a>
				</tr>
				</tbody>
				</table>
				</td>
